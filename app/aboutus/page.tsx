  ...
  return (
    ...
    <main className='p-20 pt-[18vh] flex flex-col md:flex-row h-screen'>
        ...
        <div className='basis-1/2 flex flex-col gap-6 items-center md:items-start'>
           <h1 className='text-teal-500 text-5xl font-semibold'>  Sobre nosotros</h1> 
           <div className='flex flex-col gap-4'>
            ...
            <Button variant={"ghost"} className='bg-teal-500 rounded-lg text-white w-fit h-fit p-4 py-2 text-lg'>
